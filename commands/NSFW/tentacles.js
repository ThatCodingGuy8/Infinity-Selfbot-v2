...
module.exports = {
 ...
 nsfw = await akaneko.nsfw
   ...
   Functions.SilentModeSend(new MessageEmbed().setDescription("Here you go Master!").setImage(await nsfw.tentacles()).setFooter("Ok what the fuck").setTimestamp(), msg.channel.id, msg, "Normal")
