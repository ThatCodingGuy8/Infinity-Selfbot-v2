...
module.exports = {
   ...
   await Functions.SilentModeSend(new MessageEmbed().setDescription("Here you go Master!").setImage(await nsfw.pussy()).setFooter("Sexy").setTimestamp().setColor(settings.embedcolor), msg.channel.id, msg, "Normal")
