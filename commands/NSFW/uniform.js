...
module.exports = {
 ...
 nsfw = await akaneko.nsfw
   ...
   Functions.SilentModeSend(new MessageEmbed().setDescription("Here you go Master!").setImage(await nsfw.uniform()).setFooter("Sexy").setTimestamp(), msg.channel.id, msg, "Normal")
